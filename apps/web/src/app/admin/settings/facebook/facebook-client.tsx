        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-lg border px-3 py-2.5 pr-10 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-red"
            />
