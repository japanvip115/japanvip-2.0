  ...
  return (
    <div className="space-y-6">
      ...
      {isAdmin && (
        <Link
          href="/admin"
          className="flex items-center gap-4 rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 p-4 hover:border-gray-400 hover:bg-gray-100 transition"
        >
          <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-gray-800 text-white text-xl">⚙️</span>
          <div className="flex-1 min-w-0">
            <p className="font-bold text-gray-800">Quản trị website</p>
            <p className="text-sm text-gray-500">Sản phẩm, đấu giá, đơn hàng, người dùng, cài đặt...</p>
          </div>
          <span className="shrink-0 text-xs font-semibold rounded-full bg-gray-800 text-white px-2.5 py-1">Admin</span>
        </Link>
      )}
