...
export default async function LogoSettingsPage() {
  const keys = ['site_logo_url', 'site_name', 'site_tagline_jp']
  ...
  return (
    <div className="max-w-2xl p-6">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500">Cập nhật logo, tên thương hiệu và tagline hiển thị trên website.</p>
      </div>
      <LogoSettingsForm
